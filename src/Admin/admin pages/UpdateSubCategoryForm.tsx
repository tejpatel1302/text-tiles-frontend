...
import { updateCategoryApi, updateSubCategoryApi } from "@/features/api/apicall";


const UpdateSubCategoryForm = ({ isOpen, onOpenChange, subcategory }: any) => {
    console.log(subcategory,'plezcata')
  ...
  //   }
  const handleSubCategoryUpdate = async (req:any) => {
    try {
        ...
        const res = await updateSubCategoryApi(payload, req?.id, formData);
  ...
  const updateMutation = useMutation({
    mutationFn: handleSubCategoryUpdate,
  ...
  const onSubmit: any = (values: any) => {
    ...
    updateMutation.mutate({ ...req, id: subcategory?.subcategoryID
    });
  };
