    ...
    <div >
      ...
      <div className="h-[500px] w-[400px] rounded-lg border border-gray-300  bg-white overflow-hidden shadow-lg relative transition duration-300 ease-in-out transform hover:scale-105 flex flex-col justify-center items-center">
        ...
        <div className="px-6 py-4">
          <div className="font-bold text-xl text-center mt-5">Men's Stylish Wear</div>
      ...
      <div className="h-[500px] w-[400px] rounded-lg border border-gray-300  bg-white overflow-hidden shadow-lg relative transition duration-300 ease-in-out transform hover:scale-105 flex flex-col justify-center items-center">
        ...
        <div className="px-6 py-4">
          <div className="font-bold text-xl text-center mt-5">Women's Stylish Wear</div>
      ...
      <div className="h-[500px] w-[400px] rounded-lg border border-gray-300  bg-white overflow-hidden shadow-lg relative transition duration-300 ease-in-out transform hover:scale-105 flex flex-col justify-center items-center">
        ...
        <div className="px-6 py-4">
          <div className="font-bold text-xl text-center mt-5">Children Stylish Wear</div>
